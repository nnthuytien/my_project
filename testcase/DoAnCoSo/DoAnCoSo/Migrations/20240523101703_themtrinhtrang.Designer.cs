...
namespace DoAnCoSo.Migrations
{
    ...
    [Migration("20240523101703_themtrinhtrang")]
    partial class themtrinhtrang
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DoAnCoSo.Models.ChiTietPhongBan", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DoAnCoSo.Models.PhongBan", b =>
                {
                    b.Property<int>("PBId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DoAnCoSo.Models.ChiTietPhongBan", b =>
                {
                    ...
                    b.HasOne("DoAnCoSo.Models.PhongBan", "phongBans")
                        .WithMany("chiTietPhongBans")
                        .HasForeignKey("PBId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
